...
const BenefitSection = () => {
  ...
  const content = (
    <div className="tp-section__title-wrapper">
      <Typography variant="h3" component="h3" className="tp-section__title mb-15" gutterBottom fontWeight='bold'>
        Benefit From Our <br />
      ...
      <List className="tp-about__feature-list mb-40">
        ...
        <ListItem>
          ...
          <ListItemText primary="Access more than 100K online courses" />
        </ListItem>
        <ListItem>
          <ListItemIcon>
            <Checkbox checked={true} />
